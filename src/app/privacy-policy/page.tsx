  ...
  return (
    <div className="bg-background min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-6 py-32 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8">Kebijakan Privasi (Privacy Policy)</h1>
        <div className="prose prose-invert max-w-none text-muted-foreground space-y-6">
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">1. Informasi yang Kami Kumpulkan</h2>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">2. Penggunaan Informasi</h2>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. Perlindungan Data</h2>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">4. Perubahan Kebijakan</h2>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Hubungi Kami</h2>
