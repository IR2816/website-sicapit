...
import { ArrowLeft, Leaf, Phone, Sprout, Tractor, Droplet, Sun } from 'lucide-react'
    ...
    <div className="min-h-screen flex flex-col bg-surface text-foreground antialiased selection:bg-brand selection:text-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Badge className="bg-emerald-500/20 text-emerald-400 border-emerald-500/30 px-3 py-1 mb-4 rounded-sm font-mono text-xs uppercase tracking-[0.2em] backdrop-blur-sm">
      ...
      <section className="py-20 bg-surface-strong border-t border-line text-center">
        <div className="max-w-2xl mx-auto px-4">
          <Sprout className="w-12 h-12 text-emerald-500 mx-auto mb-6" />
          <h2 className="text-3xl font-bold font-heading mb-4">Pesan Paket Pertanian</h2>
          <p className="text-muted-foreground mb-8 text-lg">Hubungi kami untuk mengatur jadwal kunjungan ke area pertanian.</p>
          {contactPhone && (
            <a href={`https://wa.me/${normalizePhoneForWhatsApp(contactPhone)}?text=Halo,%20saya%20ingin%20info%20program%20Edukasi%20Pertanian`} target="_blank" rel="noopener noreferrer">
