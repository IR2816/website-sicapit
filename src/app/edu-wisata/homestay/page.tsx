...
import { ArrowLeft, Home as HomeIcon, Coffee, Moon, Sun, Users, Phone } from 'lucide-react'
    ...
    <div className="min-h-screen flex flex-col bg-surface text-foreground antialiased selection:bg-brand selection:text-white">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Badge className="bg-rose-500/20 text-rose-400 border-rose-500/30 px-3 py-1 mb-4 rounded-sm font-mono text-xs uppercase tracking-[0.2em] backdrop-blur-sm">
      ...
      <section className="py-20 bg-surface-strong border-t border-line text-center">
        <div className="max-w-2xl mx-auto px-4">
          <HomeIcon className="w-12 h-12 text-rose-500 mx-auto mb-6" />
          <h2 className="text-3xl font-bold font-heading mb-4">Reservasi Homestay</h2>
          <p className="text-muted-foreground mb-8 text-lg">Silakan hubungi kami untuk informasi ketersediaan kamar dan harga homestay.</p>
          {contactPhone && (
            <a href={`https://wa.me/${normalizePhoneForWhatsApp(contactPhone)}?text=Halo,%20saya%20tertarik%20untuk%20reservasi%20Homestay`} target="_blank" rel="noopener noreferrer">
