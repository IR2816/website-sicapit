    ...
    <footer className="pt-20 pb-10 border-t border-line bg-surface-strong relative z-20 mt-auto">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-3">
              <a href="https://youtube.com/@hercemherman4230" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-surface flex items-center justify-center text-muted-foreground hover:text-[#FF0000] border border-line hover:border-[#FF0000]/50 transition-all hover:scale-110 shadow-sm" aria-label="YouTube">
              ...
              <a href="https://instagram.com/kampung_sicapit" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-surface flex items-center justify-center text-muted-foreground hover:text-[#E1306C] border border-line hover:border-[#E1306C]/50 transition-all hover:scale-110 shadow-sm" aria-label="Instagram">
              ...
              <a href="https://tiktok.com/@kampung_sicapit" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-surface flex items-center justify-center text-muted-foreground hover:text-[#00f2fe] border border-line hover:border-[#00f2fe]/50 transition-all hover:scale-110 shadow-sm" aria-label="TikTok">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-start gap-4 p-6 bg-surface/50 rounded-2xl border border-line hover:border-white/20 transition-colors shadow-sm backdrop-blur-sm">
              ...
              <p className="text-muted-foreground text-sm leading-loose">
                <strong className="text-foreground dark:text-white block mb-2 text-base font-bold tracking-wide">{addressTitle}</strong>
                {addressLine1}<br/>
                {addressLine2}<br/>
                {addressLine3}
              </p>
        ...
        <div className="pt-8 border-t border-line flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">&copy; {new Date().getFullYear()} Kampung Wisata Sicapit. All rights reserved.</p>
